...
const BINGO_DATA = {
  ...
  grid: [
    ...
    [
      ...
      { text: "Voir 130 films", status: "43/130", completed: false },
      {
    ...
    [
      ...
      { text: "Finir 12 livres", status: "5/12", completed: false },
      {
        text: "Collab avec un musée/média",
        status: "Pas commencé",
        completed: false,
      },
      { text: "Faire 111 séances de sport", status: "40/111", completed: false },
    ],
  ],
};
